...
public class CurrencyConverter_5{
    private double[] currencyRates;
    private String[] availableCurrencies;

    public CurrencyConverter_5() {
        this.availableCurrencies = new String[]{"EURO", "USD", "TL"};
        this.currencyRates = new double[]{1, 0.92, 0.03};
    }

    public CurrencyConverter_5(double[] currencyRates) {
        this.availableCurrencies = new String[]{"EURO", "USD", "TL"};
        this.currencyRates = currencyRates;
    }

    public CurrencyConverter_5(double[] currencyRates, String[] availableCurrencies) {
